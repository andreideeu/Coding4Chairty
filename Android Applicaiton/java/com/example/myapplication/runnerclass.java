...
public class runnerclass extends AppCompatActivity implements LocationListener {

    private static final String TAG = "runnerclass";
...
//255 249 94
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.runnerview);
    ...
    class ExampleRunnable implements Runnable {
        ...
        public void run() {
            ...
            for (int i = 0; i < seconds; i++) {
                ...
                APIConn_run apiConn = new APIConn_run();
