...
public class getData {
    ...
    public String getcon() {
        ...
        try {
            ...
            System.out.println("---------GET REQUEST RUN--------");
            ...
            ResultSet rs = stmt.executeQuery("select USERNAME,lat,lng,timestamp from RUNTEST ORDER BY userid desc fetch first 10 rows only");
            ...
            //ResultSet rs=stmt.executeQuery("select * from table WHERE tagID='dunnoyet'");
            ...
            System.out.println("Running pinpoint found "); // null
            System.out.println("");
